...
namespace Planning.UnitTest.Model
{
    ...
    public class TaskItem_Test
    {
        ...
        {
            _taskDescription = new TaskDescription(30, "testDescription", new Citizen("0000000000", "testFirstname", "testLastname", new Address("Snerlevej 11, Aalborg"), new DateTime(2016, 12, 21)), new TimePeriod(new TimeSpan(0, 30, 0)), new DateTime(2016, 12, 21), "testAssignment");
        }
